...
window.oncontextmenu = function(e) {
    if (document.body.clientWidth > 768) {
        let n = e.clientX + 10,
            ...
            b = !1;
        return o.show(), globalEvent = e, selectTextNow && window.getSelection() ? (b = !0, c.show(), m.show(), d.show(), s.show()) : (c.hide(), m.hide(), s.hide(), d.hide()), y ? (b = !0, a.show(), u.show(), domhref = y) : (a.hide(), u.hide()), M ? (b = !0, l.show(), h.show(), domImgSrc = M) : (l.hide(), h.hide()), "input" === e.target.tagName.toLowerCase() || "textarea" === e.target.tagName.toLowerCase() ? (console.log("这是一个输入框"), b = !0, r.show()) : r.hide(), "METING-JS" == e.target.nodeName ? (console.log("这是一个音乐"), b = !0, g.show(), w.show(), f.show(), p.show(), k.show()) : (g.hide(), w.hide(), f.hide(), p.hide(), k.hide()), b ? (o.hide(), i.show()) : i.hide(), rm.reloadrmSize(), n + rmWidth > window.innerWidth && (n -= rmWidth + 10), t + rmHeight > window.innerHeight && (t -= t + rmHeight - window.innerHeight), rm.showRightMenu(!0, t, n), $("#rightmenu-mask").attr("style", "display: flex"), !1
    }
},
rm.downloadimging = !1,
rm.writeClipImg = function(e) {
    ...
    0 == rm.downloadimging && (rm.downloadimging = !0, setTimeout((function() {
        copyImage(e),
...
function addRightMenuClickEvent() {
    ...
    $("#menu-commentBarrage").on("click", xingzhi.switchCommentBarrage),
    ...
    $("#menu-downloadimg").on("click", (function() {
        xingzhi.downloadImage(domImgSrc, "zhxingzhi")
    })),
    $("#menu-copyimg").on("click", (function() {
        rm.writeClipImg(domImgSrc)
    })),
    $("#menu-searchBaidu").on("click", rm.searchBaidu),
    $("#menu-music-toggle").on("click", xingzhi.musicToggle),
    $("#menu-music-back").on("click", xingzhi.musicSkipBack),
    $("#menu-music-forward").on("click", xingzhi.musicSkipForward),
    $("#menu-music-copyMusicName").on("click", (function() {
        rm.rightmenuCopyText(xingzhi.musicGetName()),
